...
urlpatterns = [
    ...
    path('purchasing/create', views.PurchasingCreate.as_view(),
         name='purchasingCreate'),
    path('purchasing/update/<int:pk>',
         views.PurchaseUpdate.as_view(), name='purchasingUpdate'),
    path('purchasing/close', views.ClosePurchaseOrder.as_view(),
         name='purchasingClose'),
    path('purchasing/open/<int:pk>',
         views.OpenPurchaseOrder.as_view(), name='purchasingOpen'),
    path('purchasing/delete', views.DeletePurchaseOrder.as_view(),
         name='purchaseDelete'),
    path('purchasing/edit', views.EditPurchaseOrder.as_view(), name='purchaseEdit'),

    path('workingonit', TemplateView.as_view(
        template_name='inprogress/underWork.html'), name='inprog'),

    path('test', (TemplateView.as_view(
        template_name='registration/login_test.html')), name='test'),
    path('workingonit', TemplateView.as_view(
        template_name='inprogress/underWork_normal.html'), name='inprog')
]
